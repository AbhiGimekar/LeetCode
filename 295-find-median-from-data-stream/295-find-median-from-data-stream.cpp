...
//firstQ is a max_heap to save the first half of the data with smaller values, and 
//secQ is a min_heap to save the second half of the data with bigger values. 
...
//After inserting, we have to balance the first half and the second half to make sure either they have the same length or the length difference is only 1.
